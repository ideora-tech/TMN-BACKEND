...
class MenuSeeder extends Seeder
{
    public function run(): void
    {
        $ids = [
            ...
            'jadwal'           => 'm0000001-0000-4000-8000-000000000024',
        ...
        $menus = [
            ...
            ['id_menu' => $ids['jadwal'],       'nama_menu' => 'Jadwal',       'path' => '/jadwal',        'id_menu_induk' => $ids['operasional'],'icon' => 'calendar',   'urutan' => 4],
            ...
            ['id_menu' => $ids['keuangan'],     'nama_menu' => 'Keuangan',     'path' => null,             'id_menu_induk' => null,              'icon' => 'receipt',    'urutan' => 4],
            ...
            // Pengaturan
            ['id_menu' => $ids['pengaturan'],      'nama_menu' => 'Pengaturan',      'path' => null,               'id_menu_induk' => null,                  'icon' => 'settings',         'urutan' => 5],
        ...
        $menuPeran = [
            ...
            [$ids['jadwal'],   'DISPATCHER'],
            [$ids['jadwal'],   'MANAGER'],
            [$ids['jadwal'],   'ADMIN'],
            [$ids['jadwal'],   'SUPERADMIN'],
            [$ids['trip'],     'DISPATCHER'],
            [$ids['trip'],     'MANAGER'],
            [$ids['trip'],     'ADMIN'],
            [$ids['trip'],     'SUPERADMIN'],
