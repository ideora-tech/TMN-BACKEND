...
class MenuSeeder extends Seeder
{
    public function run(): void
    {
        $ids = [
            ...
            'penugasan'        => 'm0000001-0000-4000-8000-000000000024',
        ...
        $menus = [
            ...
            ['id_menu' => $ids['penugasan'],    'nama_menu' => 'Penugasan',    'path' => '/penugasan',     'id_menu_induk' => $ids['operasional'],'icon' => null,         'urutan' => 4],
