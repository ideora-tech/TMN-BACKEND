...
class MenuSeeder extends Seeder
{
    public function run(): void
    {
        $ids = [
            ...
            'dashboard_armada' => 'm0000005-0000-4000-8000-000000000001',
            ...
            'vendor_grup'      => 'm0000001-0000-4000-8000-000000000070',
            ...
            'kontrak_vendor'   => 'm0000001-0000-4000-8000-000000000074',
            'evaluasi_vendor'  => 'm0000001-0000-4000-8000-000000000075',
        ...
        $menus = [
            ...
            ['id_menu' => $ids['dashboard_armada'], 'nama_menu' => 'Dashboard Armada', 'path' => '/dashboard-armada', 'id_menu_induk' => $ids['operasional'], 'icon' => 'truck', 'urutan' => 0],
            ...
            // Vendor
            ['id_menu' => $ids['vendor_grup'],      'nama_menu' => 'Vendor',           'path' => null,                'id_menu_induk' => null,                'icon' => 'building',   'urutan' => 4],
            ['id_menu' => $ids['vendor'],           'nama_menu' => 'Data Vendor',      'path' => '/vendor',           'id_menu_induk' => $ids['vendor_grup'], 'icon' => 'building',   'urutan' => 1],
            ['id_menu' => $ids['kontrak_vendor'],   'nama_menu' => 'Kontrak Vendor',   'path' => '/kontrak-vendor',   'id_menu_induk' => $ids['vendor_grup'], 'icon' => 'fileText',   'urutan' => 2],
            ['id_menu' => $ids['armada_vendor'],    'nama_menu' => 'Armada Vendor',    'path' => '/armada-vendor',    'id_menu_induk' => $ids['vendor_grup'], 'icon' => 'truck',      'urutan' => 3],
            ['id_menu' => $ids['supir_vendor'],     'nama_menu' => 'Supir Vendor',     'path' => '/supir-vendor',     'id_menu_induk' => $ids['vendor_grup'], 'icon' => 'users',      'urutan' => 4],
        ...
        $menuPeran = [
            ...
            [$ids['dashboard_armada'], 'DISPATCHER'],
            [$ids['dashboard_armada'], 'MANAGER'],
            [$ids['dashboard_armada'], 'ADMIN'],
            [$ids['dashboard_armada'], 'SUPERADMIN'],
            ...
            // Vendor section
            [$ids['vendor_grup'],      'DISPATCHER'],
            [$ids['vendor_grup'],      'MANAGER'],
            [$ids['vendor_grup'],      'ADMIN'],
            [$ids['vendor_grup'],      'SUPERADMIN'],
            [$ids['vendor'],           'DISPATCHER'],
            [$ids['vendor'],           'MANAGER'],
            [$ids['vendor'],           'ADMIN'],
            [$ids['vendor'],           'SUPERADMIN'],
            [$ids['kontrak_vendor'],   'DISPATCHER'],
            [$ids['kontrak_vendor'],   'MANAGER'],
            [$ids['kontrak_vendor'],   'ADMIN'],
            [$ids['kontrak_vendor'],   'SUPERADMIN'],
            ...
            [$ids['evaluasi_vendor'],  'DISPATCHER'],
            [$ids['evaluasi_vendor'],  'MANAGER'],
            [$ids['evaluasi_vendor'],  'ADMIN'],
            [$ids['evaluasi_vendor'],  'SUPERADMIN'],
