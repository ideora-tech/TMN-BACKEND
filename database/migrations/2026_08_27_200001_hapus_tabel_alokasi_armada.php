...
return new class extends Migration {
    /**
     * Papan Penugasan berbasis unit menyimpan armada langsung di penugasan
     * (id_armada / id_armada_vendor), jadi tabel alokasi harian warisan ini
     * tidak ditulis maupun dibaca lagi.
     */
