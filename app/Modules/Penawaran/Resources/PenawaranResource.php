...
class PenawaranResource extends JsonResource
{
    public function toArray($request): array
    {
        return [
            ...
            'email_klien'      => $this->email_klien ?? null,
            ...
            'email_terkirim_ke'   => $this->email_terkirim_ke,
            'email_terkirim_pada' => $this->email_terkirim_pada,
            'email_gagal_pada'    => $this->email_gagal_pada,
            'email_gagal_alasan'  => $this->email_gagal_alasan,
