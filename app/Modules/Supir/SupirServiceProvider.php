    ...
    public function boot(): void
    {
        Route::prefix('api')
            ...
            ->group(function () {
                ...
                Route::get('supir/me/dokumen', [SupirController::class, 'dokumenSaya']);
                Route::get('supir/me/unit', [SupirController::class, 'unitSaya']);
                Route::get('supir/{id}/dokumen', [SupirController::class, 'dokumen']);
