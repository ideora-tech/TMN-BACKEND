...
class UpdateParameterBokRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'id_jenis_bbm'           => ['sometimes', 'string', 'max:36'],
            'konsumsi_km_per_liter'  => ['sometimes', 'numeric', 'min:0.1'],
            ...
            'utilisasi_km_per_bulan' => ['sometimes', 'numeric', 'min:1'],
