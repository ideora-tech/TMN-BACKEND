...
<body>
    ...
    <div class="konten">
        ...
        <p class="periode">{{ $p->judul }}</p>

        <table class="info">
            <tr>
                <td class="label">No. Penawaran</td><td class="titik">:</td>
                <td><strong>{{ $p->nomor_penawaran }}</strong></td>
                <td class="label">Tanggal</td><td class="titik">:</td>
                <td>{{ $tgl($p->tanggal_penawaran) }}</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="label"></td><td class="titik"></td>
                <td></td>
            </tr>
        </table>
