...
class PenugasanHarianTest extends TestCase
{
    ...
    public function test_supir_boleh_ditugaskan_lagi_jika_trip_penugasan_lamanya_sudah_selesai(): void
    {
        $this->actingAsRole('SUPERADMIN');
        $proyek  = $this->makeProyek();
        $rute    = $this->makeRute();
        ...
        $armadaA = $this->makeArmada();
        $armadaB = $this->makeArmada();
        $supir   = $this->makeSupir('Dadang Rit Dua');
        ...
        $this->makeTripUntukPenugasan((string) $lama->id_penugasan, 'selesai');
