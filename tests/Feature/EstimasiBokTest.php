...
class EstimasiBokTest extends TestCase
{
    ...
    public function test_estimasi_bok_menghitung_benar(): void
    {
        ...
        $res = $this->getJson("/api/rute/estimasi-bok?id_rute={$idRute}&id_jenis_kendaraan={$idJenis}&estimasi_tol=100000");
    ...
    public function test_estimasi_tanpa_tol(): void
    {
        ...
        $res = $this->getJson("/api/rute/estimasi-bok?id_rute={$idRute}&id_jenis_kendaraan={$idJenis}");
    ...
    public function test_estimasi_tanpa_parameter_mengembalikan_null(): void
    {
        ...
        $res = $this->getJson('/api/rute/estimasi-bok?id_rute=' . $this->makeRute()
    ...
    public function test_estimasi_rute_perusahaan_lain_404(): void
    {
        ...
        $res = $this->getJson('/api/rute/estimasi-bok?id_rute=' . $this->makeRute(100.0, $lain)
            . '&id_jenis_kendaraan=' . $this->makeJenisKendaraan());
